...
public class LudeiContentView extends FrameLayout {
    ...
    public void loadUrl(String url) {
        ...
        this.postTask(new Runnable() {
            @Override
            public void run() {
            	getContentViewCore().getWebContents().getNavigationController().loadUrl(params);
            }
        });
    ...
    public void reload() {
        ContentViewCore contentView = this.getContentViewCore();
        if (contentView != null) {
            contentView.getWebContents().getNavigationController().reload(true);
        }
    }

    public boolean canGoBack() {
        ContentViewCore contentView = this.getContentViewCore();
        return contentView != null ? contentView.getWebContents().getNavigationController().canGoBack() : false;
    }

    public void goBack() {
        ContentViewCore contentView = this.getContentViewCore();
        if (contentView != null) {
            contentView.getWebContents().getNavigationController().goBack();
        }
    }

    public boolean canGoForward() {
        ContentViewCore contentView = this.getContentViewCore();
        return contentView != null ? contentView.getWebContents().getNavigationController().canGoForward() : false;
    }

    public void goForward() {
        ContentViewCore contentView = this.getContentViewCore();
        if (contentView != null) {
            contentView.getWebContents().getNavigationController().goForward();
        }
    }
    ...
    public String getUrl() {
        ContentViewCore contentView = this.getContentViewCore();
        return contentView != null ? contentView.getWebContents().getUrl() : "";
    }

    public String getTitle() {
        ContentViewCore contentView = this.getContentViewCore();
        return contentView != null ? contentView.getWebContents().getTitle() : "";
    }
    ...
    public void clearHistory() {
        ContentViewCore contentView = this.getContentViewCore();
        if (contentView != null) {
            contentView.getWebContents().getNavigationController().clearHistory();
        }
    }
    ...
    public void clearSslPreferences() {
        ContentViewCore contentView = this.getContentViewCore();
        if (contentView != null) {
            contentView.getWebContents().getNavigationController().clearSslPreferences();
        }
    }
    ...
    public WebBackForwardList copyBackForwardList() {
    	ContentViewCore contentView = this.getContentViewCore();
        return LudeiWebBackForwardList.newInstance(contentView.getWebContents().getNavigationController().getNavigationHistory());
    }
